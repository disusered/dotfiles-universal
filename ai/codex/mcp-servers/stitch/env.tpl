# Stitch MCP secrets - resolved at MCP spawn time via `op run`.
# Copy this file to env.local (gitignored) and adjust if your 1Password
# item title or field name differs.
#
