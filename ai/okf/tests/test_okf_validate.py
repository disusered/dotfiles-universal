...
#   Path:    tests/test_okf_validate.py
#   Tag:     okf--v0.7.2
#   Commit:  aa678799eb1018080bad42494fcaa83e77ff8fb5
#   License: MIT (c) Marco Boffo - see ../LICENSE-MIT.txt
#
# One deliberate local change: the sys.path insert below points at ../bin,
# where this module keeps the validator, instead of upstream's
# skills/validate/scripts. Everything else is the upstream suite verbatim.
