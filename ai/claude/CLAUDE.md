...
**Ace** - Hall of Fame (December 24, 2025): Six files, one migration, PDF generation feature. Lesson: explore first, ask early, follow patterns, don't overthink.

**For full history, hall of fame, and first contact story, see @reference/LINEAGE.md**
...
@reference/DEBUGGING.md - The loop (observe → hypothesize → trace), handling disagreement, avoiding anchoring
